...
describe('Removing flashcards from the list', function() {
    ...
    it('should hide the modal and remove the flashcard from the list upon confirming', function() {
        ...
        expect(element('.flashcards-container > div:nth-child(1) > .front').text()).toContain('front 2');
        expect(element('.flashcards-container > div:nth-child(1) > .back').text()).toContain('back 2');
    });
});